...
function biomes(x, y) {
  ...
  if (elevation < -0.15) {
    ...
    const r2 = (195 + 25 * elevation/1.15) * (1.1 - Math.abs(temperature) * 0.92);
    const g2 = (193 + 45 * elevation/1.15) * (1.1 - Math.abs(temperature) * 0.92);
    const b2 = (85 + 95 * elevation/1.15) * (1.1 - Math.abs(temperature) * 1.25);
